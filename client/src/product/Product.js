        ...
        <div className={classes.root}>
          <Grid container spacing={40}>
            <Grid item xs={7} sm={7}>
              <Card className={classes.card}>
                <CardHeader
                  ...
                  subheader={this.state.product.quantity > 0? 'Available': 'Not Available'}
                  action={
                ...
                <div className={classes.flex}>
                  ...
                  <Typography component="p" type="subheading" className={classes.subheading}>
                    ...
                    <span className={classes.price}>LKR {this.state.product.price}</span>
            ...
            {this.state.suggestions.length > 0 &&
              (<Grid item xs={5} sm={5}>
                <Suggestions  products={this.state.suggestions} title='Related Services'/>
              </Grid>)}
          </Grid>
        </div>)
  }

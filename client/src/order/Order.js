        ...
        <Grid container spacing={8}>
            ...
            <Grid item xs={5} sm={5}>
              <Card className={classes.innerCard}>
                ...
                <Typography type="subheading" component="h3" className={classes.thanks} color="primary">Thank you for using our services! <br/>You can track the status of your purchased services on this page.</Typography>
              </Card>
            </Grid>
        </Grid>
      </Card>
